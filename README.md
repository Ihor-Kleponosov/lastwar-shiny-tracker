...
- Preset transfer: choose one or more saved presets and download their unchanged `id`, `name`, and `enabledServerIds` data in a versioned `.lwst` file containing JSON; Import validates that format and lets you choose which presets to add as new copies
